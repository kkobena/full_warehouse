...
- [Setting up PrimeNG in an Angular CLI project](https://primeng.org/installation)
- [Angular Data Grid](https://www.ag-grid.com/angular-data-grid/getting-started/)
...
https://github.com/kkobena/full_warehouse.git
