...
public class OrderLineResourceIT {
  ...
  private static final LocalDateTime DEFAULT_RECEIPT_DATE = LocalDateTime.now().minusMonths(2);
  private static final LocalDateTime UPDATED_RECEIPT_DATE =
  ...
  @Autowired private MockMvc restOrderLineMockMvc;
  ...
  public static OrderLine createEntity(EntityManager em) {
    OrderLine orderLine =
        new OrderLine()
            .setReceiptDate(DEFAULT_RECEIPT_DATE)
  ...
  public static OrderLine createUpdatedEntity(EntityManager em) {
    OrderLine orderLine =
        new OrderLine()
            .setReceiptDate(UPDATED_RECEIPT_DATE)
  ...
  public void getAllOrderLines() throws Exception {
    ...
    restOrderLineMockMvc
        .perform(get("/api/order-lines?sort=id,desc"))
  ...
  public void getOrderLine() throws Exception {
    ...
    // Get the orderLine
    restOrderLineMockMvc
        .perform(get("/api/order-lines/{id}", orderLine.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  public void getNonExistingOrderLine() throws Exception {
    // Get the orderLine
    restOrderLineMockMvc
        .perform(get("/api/order-lines/{id}", Long.MAX_VALUE))
  ...
  public void deleteOrderLine() throws Exception {
    ...
    restOrderLineMockMvc
        .perform(
            delete("/api/order-lines/{id}", orderLine.getId())
                .with(csrf())
