...
public class GroupeFournisseurResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new groupeFournisseurDTO, or with status {@code 400 (Bad Request)} if the groupeFournisseur has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated groupeFournisseurDTO,
     * or with status {@code 400 (Bad Request)} if the groupeFournisseurDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the groupeFournisseurDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the groupeFournisseurDTO, or with status {@code 404 (Not Found)}.
     */
