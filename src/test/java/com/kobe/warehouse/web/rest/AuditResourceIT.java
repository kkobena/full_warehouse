...
public class AuditResourceIT {
  ...
  private static final Instant SAMPLE_TIMESTAMP =
      LocalDateTime.parse("2015-08-04T10:11:30Z").toInstant(ZoneOffset.UTC);
  private static final long SECONDS_PER_DAY = 60 * 60 * 24;

  @Autowired private PersistenceAuditEventRepository auditEventRepository;

  private PersistentAuditEvent auditEvent;

  @Autowired private MockMvc restAuditMockMvc;
  ...
  public void getNonExistingAuditsByDate() throws Exception {
    ...
    // sample audit
    String fromDate =
        SAMPLE_TIMESTAMP.minusSeconds(2 * SECONDS_PER_DAY).toString().substring(0, 10);
  ...
  public void getNonExistingAudit() throws Exception {
    // Get the audit
    restAuditMockMvc
        .perform(get("/management/audits/{id}", Long.MAX_VALUE))
