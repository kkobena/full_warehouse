...
// @AnalyzeClasses(packagesOf = WarehouseApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
  ...
  static final ArchRule respectsTechnicalArchitectureLayers =
      layeredArchitecture()
          ...
          .ignoreDependency(belongToAnyOf(WarehouseApp.class), alwaysTrue())
          .ignoreDependency(
              alwaysTrue(),
              belongToAnyOf(
                  com.kobe.warehouse.config.Constants.class,
                  com.kobe.warehouse.config.ApplicationProperties.class));
}
