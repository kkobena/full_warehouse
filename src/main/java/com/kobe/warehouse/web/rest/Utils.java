...
public final class Utils {
  ...
  public static ResponseEntity<Resource> printPDF(
      String gereratefilePath, HttpServletRequest request) throws MalformedURLException {
  ...
  private static ResponseEntity<Resource> getDocument(
      Resource resource, String defaultContentType, HttpServletRequest request) {
