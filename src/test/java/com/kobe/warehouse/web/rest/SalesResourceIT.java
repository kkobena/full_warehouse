...
import com.kobe.warehouse.web.rest.sales.SalesResource;
...
public class SalesResourceIT {
  ...
  @Autowired private MockMvc restSalesMockMvc;
  ...
  public void getAllSales() throws Exception {
    ...
    restSalesMockMvc
        .perform(get("/api/sales?sort=id,desc"))
  ...
  public void getSales() throws Exception {
    ...
    // Get the sales
    restSalesMockMvc
        .perform(get("/api/sales/{id}", sales.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  public void getNonExistingSales() throws Exception {
    // Get the sales
    restSalesMockMvc
        .perform(get("/api/sales/{id}", Long.MAX_VALUE))
  ...
  public void deleteSales() throws Exception {
    ...
    restSalesMockMvc
        .perform(
            delete("/api/sales/{id}", sales.getId())
                .with(csrf())
