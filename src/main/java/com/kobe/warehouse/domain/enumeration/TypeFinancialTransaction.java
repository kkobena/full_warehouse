...
public enum TypeFinancialTransaction {
  ...
  VENTES_DEPOTS(
      "Ventes dépôts", CategorieTransaction.VENTES, TransactionTypeAffichage.VENTES_DEPOTS),
  VENTES_DEPOTS_AGREE("VO", CategorieTransaction.VENTES, TransactionTypeAffichage.VO),
  REGLEMENT_DIFFERE(
      "Règlements différés",
      CategorieTransaction.ENTREE,
      TransactionTypeAffichage.REGLEMENT_DIFFERE),
  REGLEMENT_TIERS_PAYANT(
      "Règlements tiers payant",
      CategorieTransaction.ENTREE,
      TransactionTypeAffichage.REGLEMENT_TIERS_PAYANT),
  SORTIE_CAISSE(
      "Sortie de caisse",
      CategorieTransaction.SORTIE_CAISSE,
      TransactionTypeAffichage.SORTIE_CAISSE),
  ENTREE_CAISSE(
      "Entrée de caisse", CategorieTransaction.ENTREE, TransactionTypeAffichage.ENTREE_CAISSE),
  FONDS_CAISSE(
      "Fonds de caisse",
      CategorieTransaction.SORTIE_CAISSE,
      TransactionTypeAffichage.SORTIE_CAISSE),
