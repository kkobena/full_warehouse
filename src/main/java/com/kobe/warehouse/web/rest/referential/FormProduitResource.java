...
public class FormProduitResource {
     ...
     * formProduitDTO, or with status {@code 400 (Bad Request)} if the formProduitDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the formProduitDTO couldn't be
     * updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of formProduits
     * in body.
     */
