...
public class SalesResourceProxy {
  ...
  public ResponseEntity<CashSaleDTO> createCashSale(
      CashSaleDTO cashSaleDTO, HttpServletRequest request) throws URISyntaxException {
  ...
  public ResponseEntity<FinalyseSaleDTO> closeCashSale(
      CashSaleDTO cashSaleDTO, HttpServletRequest request) {
    if (cashSaleDTO.getId() == null) {
      throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
    }
  ...
  public ResponseEntity<SaleLineDTO> addItemComptant(SaleLineDTO saleLineDTO)
  ...
  public ResponseEntity<SaleLineDTO> updateItemQtyRequested(SaleLineDTO saleLineDTO)
      throws URISyntaxException {
  ...
  public ResponseEntity<SaleLineDTO> updateItemPrice(SaleLineDTO saleLineDTO)
      throws URISyntaxException {
    log.debug("REST request to save saleLineDTO : {}", saleLineDTO);
  ...
  public ResponseEntity<SaleLineDTO> updateItemQtySold(SaleLineDTO saleLineDTO)
      throws URISyntaxException {
    log.debug("REST request to save saleLineDTO : {}", saleLineDTO);
