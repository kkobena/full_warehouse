...
public interface CustomizedProductService {
  ...
  Optional<FournisseurProduit> getFournisseurProduitByCriteria(
  ...
  default StockProduit buildStockProduitFromStockProduitDTO(
      StockProduitDTO dto, StockProduit stockProduit) {
