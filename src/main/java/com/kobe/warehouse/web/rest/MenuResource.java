...
public class MenuResource {
   ...
   *     or with status {@code 400 (Bad Request)} if the menu is not valid, or with status {@code
   *     500 (Internal Server Error)} if the menu couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/menus")
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the menu, or with
