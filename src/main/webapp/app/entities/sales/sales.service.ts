...
export class SalesService {
  ...
  transformToVenteComptant(id: SaleId): Observable<HttpResponse<SaleId>> {
    return this.http.put<SaleId>(`${this.resourceUrl}/comptant/transform`, id, {observe: 'response'});
  }

  transformToVenteAssurance(id: SaleId): Observable<HttpResponse<SaleId>> {
  ...
  printDevisPdf(id: SaleId): Observable<Blob> {
