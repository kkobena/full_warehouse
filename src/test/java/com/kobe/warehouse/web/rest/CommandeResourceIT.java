...
public class CommandeResourceIT {
  ...
  @Autowired private MockMvc restCommandeMockMvc;
  ...
  public void getAllCommandes() throws Exception {
    ...
    restCommandeMockMvc
        .perform(get("/api/commandes?sort=id,desc"))
  ...
  public void getCommande() throws Exception {
    ...
    // Get the commande
    restCommandeMockMvc
        .perform(get("/api/commandes/{id}", commande.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  public void getNonExistingCommande() throws Exception {
    // Get the commande
    restCommandeMockMvc
        .perform(get("/api/commandes/{id}", Long.MAX_VALUE))
  ...
  public void deleteCommande() throws Exception {
    ...
    restCommandeMockMvc
        .perform(
            delete("/api/commandes/{id}", commande.getId())
                .with(csrf())
