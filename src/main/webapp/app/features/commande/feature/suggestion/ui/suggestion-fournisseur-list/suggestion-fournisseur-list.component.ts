...
export class SuggestionFournisseurListComponent {
  ...
  protected readonly colDefs: ColDef<FournisseurSuggestionSummary>[] = [
    ...
    },
    {
      ...
      width: 175,
      sortable: false,
      cellRenderer: SuggestionFournisseurActionsComponent
    }
  ];

  protected readonly gridContext: { componentParent: SuggestionFournisseurListComponent } = { componentParent: this };
