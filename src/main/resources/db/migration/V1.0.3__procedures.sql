...
alter procedure proc_close_inventory(bigint, inout integer) owner to warehouse;
...
alter function gettopqty80percentproducts(date, date, varchar, varchar) owner to warehouse;
...
alter function gettopamount80percentproducts(date, date, varchar, varchar) owner to warehouse;
