...
(
  ...
  code_office_pharma_ml    varchar(50)  null,
  code_recepteur_pharma_ml varchar(50)  null,
  email                    varchar(255) null,
  id_recepteur_pharma_ml   varchar(50)  null,
  libelle                  varchar(255) not null,
  num_faxe                 varchar(255) null,
  odre                     int          not null,
  tel                      varchar(255) null,
  url_pharma_ml            varchar(150) null,
...
create or replace table historique_inventaire
(
  id                         bigint       not null
    primary key,
  created_at                 datetime(6)  not null,
  description                varchar(255) not null,
  gap_amount                 bigint       null,
  gap_cost                   bigint       null,
...
(
  ...
  ordre            int                                          not null,
  racine           bit                                          not null,
  type_menu        enum ('ALL', 'JAVA_CLIENT', 'MOBILE', 'WEB') not null,
...
(
  ...
  historique_inventaire   longtext collate utf8mb4_bin                    null
    check (json_valid(`historique_inventaire`)),
...
create or replace table substitut
(
  id             bigint auto_increment
    primary key,
...
(
  ...
  has_been_submitted_to_pharmaml bit default b'0'                         not null,
  ht_amount                      int default 0                            null,
  order_amount                   int                                      null comment 'montant vente de la commande en cours de traitement',
...
(
  ...
  product_still_out_of_stock bit                           not null,
  qty                        int                           not null,
  commande_id                bigint                        not null,
  user_id                    bigint                        not null,
  fournisseur_id             bigint                        not null,
...
(
  ...
  nbre_bordereau            int(6)                                null,
  ncc                       varchar(100)                          null comment 'Identifiant contribuable',
...
create or replace table sales_line_price
(
  id                     bigint auto_increment
    primary key,
  montant                int    not null,
  prix                   int    not null,
  option_prix_produit_id bigint not null,
  sale_line_id           bigint not null,
  constraint UKlftmrs5kba3h91m9rbqq7ia85
    unique (option_prix_produit_id, sale_line_id),
  constraint FK9nmuhva8j8x5ibcuq0ldh829m
    foreign key (sale_line_id) references sales_line (id),
  constraint FKqd8m05gwct7j49elb8fgys7d7
    foreign key (option_prix_produit_id) references produit_tiers_payant_prix (id)
);
