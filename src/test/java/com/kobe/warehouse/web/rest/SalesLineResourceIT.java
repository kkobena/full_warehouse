...
public class SalesLineResourceIT {
  ...
  @Autowired private MockMvc restSalesLineMockMvc;
  ...
  public void getAllSalesLines() throws Exception {
    ...
    restSalesLineMockMvc
        .perform(get("/api/sales-lines?sort=id,desc"))
  ...
  public void getSalesLine() throws Exception {
    ...
    // Get the salesLine
    restSalesLineMockMvc
        .perform(get("/api/sales-lines/{id}", salesLine.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  public void getNonExistingSalesLine() throws Exception {
    // Get the salesLine
    restSalesLineMockMvc
        .perform(get("/api/sales-lines/{id}", Long.MAX_VALUE))
  ...
  public void deleteSalesLine() throws Exception {
    ...
    restSalesLineMockMvc
        .perform(
            delete("/api/sales-lines/{id}", salesLine.getId())
                .with(csrf())
