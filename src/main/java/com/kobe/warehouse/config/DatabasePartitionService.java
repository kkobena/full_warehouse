...
public class DatabasePartitionService {
    ...
    private final DateTimeFormatter suffixFormatter = DateTimeFormatter.ofPattern("yyyy_MM");
   // private boolean partitioExist = false;
    ...
    public void createMonthlyPartition(String parentTable, Year year) {
        ...
        boolean  partitioExist = jdbcClient.sql(existsSql)
