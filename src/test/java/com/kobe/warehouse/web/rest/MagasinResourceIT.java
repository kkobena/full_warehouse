...
public class MagasinResourceIT {
  ...
  @Autowired private MockMvc restMagasinMockMvc;
  ...
  public void getAllMagasins() throws Exception {
    ...
    restMagasinMockMvc
        .perform(get("/api/magasins?sort=id,desc"))
  ...
  public void getMagasin() throws Exception {
    ...
    // Get the magasin
    restMagasinMockMvc
        .perform(get("/api/magasins/{id}", magasin.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  public void getNonExistingMagasin() throws Exception {
    // Get the magasin
    restMagasinMockMvc
        .perform(get("/api/magasins/{id}", Long.MAX_VALUE))
  ...
  public void deleteMagasin() throws Exception {
    ...
    restMagasinMockMvc
        .perform(
            delete("/api/magasins/{id}", magasin.getId())
                .with(csrf())
