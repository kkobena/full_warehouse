...
public class LogsService {
    ...
    public LogsService(LogsRepository logsRepository, UserService userService, MessageSource messageSource) {
    ...
    public void create(TransactionType transactionType, String messageKey, Object[] messageArgs, String indentityKey) {
        Logs logs = new Logs();
    ...
    public void create(TransactionType transactionType, String comments, String indentityKey, String old, String newObject) {
        Logs logs = new Logs();
        logs.setComments(comments);
        logs.setIndentityKey(indentityKey);
        logs.setTransactionType(transactionType);
