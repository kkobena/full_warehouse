...
public class MotifRetourProduitRessource {
  ...
  public ResponseEntity<Void> create(@Valid @RequestBody MotifRetourProduit entity)
      throws Exception {
    if (entity.getId() != null) {
      throw new BadRequestAlertException(
          "A new MotifRetourProduit cannot already have an ID", ENTITY_NAME, "idexists");
    }
  ...
  public ResponseEntity<Void> update(@Valid @RequestBody MotifRetourProduit entity)
      throws Exception {
    if (entity.getId() == null) {
  ...
  public ResponseEntity<List<MotifRetourProduit>> getAll(
    ...
    Page<MotifRetourProduit> page =
        motifRetourProduitRepository.findAllByLibelleContainingIgnoreCaseOrderByLibelleAsc(
            search, pageable);
    HttpHeaders headers =
