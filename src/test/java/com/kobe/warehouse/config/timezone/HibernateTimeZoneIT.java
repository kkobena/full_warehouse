package com.kobe.warehouse.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.kobe.warehouse.IntegrationTest;
import com.kobe.warehouse.repository.timezone.DateTimeWrapper;
import com.kobe.warehouse.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
  ...
  @Autowired private DateTimeWrapperRepository dateTimeWrapperRepository;
  ...
  @Test
  @Transactional
  void storeLocalDateTimeWithZoneIdConfigShouldBeStoredOnGMTTimeZone0() {
    dateTimeWrapperRepository.saveAndFlush(dateTimeWrapper);
