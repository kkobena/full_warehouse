...
INSERT INTO authority (name, libelle)
VALUES ('ROLE_SUPER_USER', 'Super user dev')
ON CONFLICT (name) DO NOTHING;
...
VALUES (nextval('famille_produit_id_seq'), '1050', 'MEDICAMENTS FRANCE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1041', 'H', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '3020', 'PRODUITS CLARINS', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '3040', 'PRODUITS BUCCO-DENTAIRES', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1060', 'PRODUITS CANCERO ROCHE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '8010', 'OSTEO-SYNTHESE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '6002', 'PIECES MONNAIE MESURE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1070', 'PRODUITS CANCERO AVENTIS', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1080', 'MEDICAMENTS MARGE REDUITE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1000', 'SPECIALITES PUBLIQUES', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1010', 'SPECIALITES HOPITAL', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1020', 'DECONDITIONNES', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1030', 'GENERIQUES', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1040', 'HOMEOPATHIE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '1900', 'PART 1/3 PAYANT', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '2000', 'VETERINAIRES', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '3000', 'PARFUMERIE LOCALE N1', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '3010', 'PARFUMERIE LOCALE N2', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '4000', 'ORTHOPEDIE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '5000', 'LAITS/ FARINES/ DIETETIQUE INF.', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '7000', 'CHIMIQUES', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '6000', 'DIETETIQUE ADULTE', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '8000', 'ACCESSOIRES', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '9000', 'DIVERS', 1)
ON CONFLICT (id) DO NOTHING;
INSERT INTO famille_produit (id, code, libelle, categorie_id)
VALUES (nextval('famille_produit_id_seq'), '3030', 'PARFUMERIE FRANCE', 6)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO payment_mode ("code", "libelle", "payment_group", "ordre_tri", "enable")
VALUES ('OM', 'ORANGE', 'MOBILE', 2, true)
ON CONFLICT (code) DO NOTHING;
INSERT INTO payment_mode ("code", "libelle", "payment_group", "ordre_tri", "enable")
VALUES ('MTN', 'MTN', 'MOBILE', 3, true)
ON CONFLICT (code) DO NOTHING;
INSERT INTO payment_mode ("code", "libelle", "payment_group", "ordre_tri", "enable")
VALUES ('MOOV', 'MOOV', 'MOBILE', 4, true)
ON CONFLICT (code) DO NOTHING;
INSERT INTO payment_mode ("code", "libelle", "payment_group", "ordre_tri", "enable")
VALUES ('WAVE', 'WAVE', 'MOBILE', 5, true)
ON CONFLICT (code) DO NOTHING;
INSERT INTO payment_mode ("code", "libelle", "payment_group", "ordre_tri", "enable")
VALUES ('CB', 'CARTE BANCAIRE', 'CB', 6, true)
ON CONFLICT (code) DO NOTHING;
INSERT INTO payment_mode ("code", "libelle", "payment_group", "ordre_tri", "enable")
VALUES ('VIREMENT', 'VIREMENT', 'VIREMENT', 7, true)
ON CONFLICT (code) DO NOTHING;
INSERT INTO payment_mode ("code", "libelle", "payment_group", "ordre_tri", "enable")
