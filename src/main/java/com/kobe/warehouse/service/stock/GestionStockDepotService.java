...
public interface GestionStockDepotService {
    ...
    Page<DepotExtensionSaleDTO> getVenteDepot(PaymentStatus paymentStatus, Long depotId, String search, LocalDate fromDate, LocalDate toDate, Long userId, Pageable pageabl);
}
