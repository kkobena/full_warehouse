...
public class PaymentFournisseurResourceIT {
  ...
  @Autowired private PaymentFournisseurRepository paymentFournisseurRepository;

  @Autowired private EntityManager em;

  @Autowired private MockMvc restPaymentFournisseurMockMvc;
  ...
  public static PaymentFournisseur createEntity(EntityManager em) {
    PaymentFournisseur paymentFournisseur =
  ...
  public void createPaymentFournisseur() throws Exception {
    ...
    restPaymentFournisseurMockMvc
        .perform(
            post("/api/payment-fournisseurs")
                .with(csrf())
    ...
    PaymentFournisseur testPaymentFournisseur =
        paymentFournisseurList.get(paymentFournisseurList.size() - 1);
  ...
  public void getAllPaymentFournisseurs() throws Exception {
    ...
    restPaymentFournisseurMockMvc
        .perform(get("/api/payment-fournisseurs?sort=id,desc"))
  ...
  public void getPaymentFournisseur() throws Exception {
    ...
    restPaymentFournisseurMockMvc
        .perform(get("/api/payment-fournisseurs/{id}", paymentFournisseur.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
  ...
  public void getNonExistingPaymentFournisseur() throws Exception {
    // Get the paymentFournisseur
    restPaymentFournisseurMockMvc
        .perform(get("/api/payment-fournisseurs/{id}", Long.MAX_VALUE))
  ...
  public void updatePaymentFournisseur() throws Exception {
    ...
    PaymentFournisseur updatedPaymentFournisseur =
        paymentFournisseurRepository.findById(paymentFournisseur.getId()).get();
    // Disconnect from session so that the updates on updatedPaymentFournisseur are not directly
    // saved in db
  ...
  public void deletePaymentFournisseur() throws Exception {
    ...
    restPaymentFournisseurMockMvc
        .perform(
            delete("/api/payment-fournisseurs/{id}", paymentFournisseur.getId())
                .with(csrf())
