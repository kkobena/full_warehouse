...
import com.kobe.warehouse.domain.HasConsommation;
...
class ConsommationServiceTest {
    ...
    private static class TestEntity implements HasConsommation {
    ...
    private static class TestEntityWithInteger implements HasConsommation {
