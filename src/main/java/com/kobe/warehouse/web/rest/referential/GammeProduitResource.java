...
public class GammeProduitResource {
     ...
     * body the new gammeProduitDTO, or with status
     * {@code 400 (Bad Request)} if the gammeProduit has already an ID.
     ...
     * the updated gammeProduitDTO, or with status {@code 400 (Bad Request)}
     * if the gammeProduitDTO is not valid, or with status
     * {@code 500 (Internal Server Error)} if the gammeProduitDTO couldn't
     * be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     * the gammeProduitDTO, or with status {@code 404 (Not Found)}.
     */
