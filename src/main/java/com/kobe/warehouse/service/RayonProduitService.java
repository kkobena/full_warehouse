...
public class RayonProduitService {
    ...
    public RayonProduitService(RayonProduitRepository rayonProduitRepository, RayonRepository rayonRepository, StockProduitRepository stockProduitRepository) {
    ...
    public Optional<RayonProduitDTO> create(RayonProduitDTO dto) throws GenericError {
        ...
        if (error > 0)
            throw new GenericError("produit", "Le produit est déjà rattaché à un autre rayon dans ce stockage", "duplicateProduitStockage");
    ...
    public void delete(long id) throws GenericError {
        ...
        if (stockProduit != null && (stockProduit.getQtyStock() > 0 || stockProduit.getQtyUG() > 0))
            throw new GenericError("produit", "Le produit est en stock dans ce rayon", "stockConflic2802");
