...
public class ProductsToDestroyExcelListener extends AnalysisEventListener<ProductToDestroyDTO> {

    private final List<ProductToDestroyDTO> datas = new ArrayList<>();

    @Override
    public void invoke(ProductToDestroyDTO data, AnalysisContext context) {
        datas.add(data);
    }
    ...
    public List<ProductToDestroyDTO> getDatas() {
        return datas;
    }
    /*
