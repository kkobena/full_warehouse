...
(
  ...
  phone                   varchar(255),
  site                    varchar(255),
  groupe_pournisseur_id   integer      not null
...
(
  ...
  ug                   integer
    constraint importation_echouee_ligne_ug_check
      check (ug >= 0),
  importationechoue_id integer not null
...
(
  ...
  compte_contribuable varchar(50),
  email               varchar(100),
  ...
  name                varchar(255) not null
    constraint ukjj7fulne1dmx3boof0itbmj8n
      unique,
  note                varchar(255),
  num_comptable       varchar(50),
  phone               varchar(20),
  registre            varchar(255),
  registre_imposition varchar(100),
...
(
  ...
  description     varchar(255) not null,
  options         jsonb,
  other_value     varchar(20),
  updated         timestamp(6),
  value           varchar(20)  not null,
  value_type      varchar(11)  not null
...
(
  ...
  cash_fund_type   varchar(8)   not null
...
(
  ...
  poids_ca                    numeric(3, 2) not null,
  poids_frequence             numeric(3, 2) not null,
  poids_rotation              numeric(3, 2) not null,
  rotation_a                  numeric(5, 2) not null,
  rotation_a_plus             numeric(5, 2) not null,
  rotation_b                  numeric(5, 2) not null,
  rotation_c                  numeric(5, 2) not null,
  seuil_a                     integer       not null
    constraint classification_config_seuil_a_check
      check ((seuil_a <= 100) AND (seuil_a >= 0)),
  seuil_a_plus                integer       not null
    constraint classification_config_seuil_a_plus_check
      check ((seuil_a_plus <= 100) AND (seuil_a_plus >= 0)),
  seuil_b                     integer       not null
    constraint classification_config_seuil_b_check
      check ((seuil_b <= 100) AND (seuil_b >= 0)),
  seuil_c                     integer       not null
...
(
  ...
  paiment_status                 varchar(10)  not null
...
(
  ...
  created_at       timestamp(6) not null,
  indentity_key    varchar(20)  not null,
  new_object       text,
  old_object       text,
...
(
  code          varchar(50)  not null
    primary key,
  enable        boolean      not null,
  payment_group varchar(15)  not null
...
(
  ...
  updated                timestamp(6),
  fournisseur_produit_id integer      not null
...
(
  ...
  remise_produit_id integer              not null
...
(
  id            integer generated by default as identity
    primary key,
  date_mtv      timestamp(6) not null,
  retour_bon_id integer      not null
...
(
  ...
  classe_criticite             varchar(10)
    constraint produit_aud_classe_criticite_check
      check ((classe_criticite)::text = ANY
             ((ARRAY ['A_PLUS'::character varying, 'A'::character varying, 'B'::character varying, 'C'::character varying, 'D'::character varying])::text[])),
  code_ean_labo                varchar(13),
  ...
  is_classification_overridden boolean default false,
  ...
  qty_appro                    integer default 1,
  qty_seuil_mini               integer default 1,
...
(
  ...
  ca                              varchar(15)  not null
    constraint sales_ca_check
      check ((ca)::text = ANY
             ((ARRAY ['CA'::character varying, 'CA_DEPOT'::character varying, 'CALLEBASE'::character varying, 'TO_IGNORE'::character varying, 'IMPORT'::character varying])::text[])),
  commentaire                     varchar(255),
  ...
  number_transaction              varchar(20)  not null,
...
create table retour_depot
(
  id               integer generated by default as identity
    primary key,
  date_mtv         timestamp(6) not null,
  depot_id         integer      not null
    constraint fke7jl6h8fvosfoxbutr94uix8d
      references magasin,
  user_id          integer      not null
    constraint fkickq33qk3apkfg9m6me1h4e34
      references app_user,
  vente_depot_id   bigint,
  vente_depot_date date,
  constraint fks6jr8pmcyh6s0o49qo1lofoiw
    foreign key (vente_depot_id, vente_depot_date) references sales
);
  ...
  storage_type varchar(20)  not null
    constraint storage_storage_type_check
      check ((storage_type)::text = ANY
             ((ARRAY ['PRINCIPAL'::character varying, 'SAFETY_STOCK'::character varying])::text[])),
  magasin_id   integer      not null
...
(
  ...
  category                   varchar(20)  not null
    constraint store_inventory_category_check
      check ((category)::text = ANY
             ((ARRAY ['STOCK_TOTAL'::character varying, 'PAR_LOT'::character varying])::text[])),
  created_at                 timestamp(6) not null,
  description                varchar(255),
  gap_amount                 integer,
  gap_cost                   integer,
...
(
  ...
  suggession_reference varchar(20),
...
(
  ...
  last_user_edit_id integer
    constraint fk4fwe5m6hlx93jd4kqslauy3r
      references app_user,
  magasin_id        integer      not null
...
(
  ...
  telephone_fixe            varchar(15),
  updated                   timestamp(6) not null,
  groupe_tiers_payant_id    integer
...
(
  ...
  updated             timestamp(6) not null,
  assured_customer_id integer      not null
    constraint fkb627stp58elnn5yel8hi27tju
      references customer,
  tierspayant_id      integer      not null
...
create index generation_code_index
  on facture_tiers_payant (generation_code);
...
(
  ...
  updated_at              timestamp(6) not null,
  client_tiers_payant_id  integer      not null
...
(
  ...
  classe_criticite                 varchar(10)
    constraint produit_classe_criticite_check
      check ((classe_criticite)::text = ANY
             ((ARRAY ['A_PLUS'::character varying, 'A'::character varying, 'B'::character varying, 'C'::character varying, 'D'::character varying])::text[])),
  code_ean_labo                    varchar(13),
  code_remise                      varchar(6)
  ...
  status                           varchar(10)       not null
    constraint produit_status_check
      check ((status)::text = ANY
             ((ARRAY ['ENABLE'::character varying, 'DISABLE'::character varying, 'DELETED'::character varying, 'CLOSED'::character varying])::text[])),
  type_produit                     varchar(15)       not null
  ...
  fournisseur_produit_principal_id integer
...
(
  ...
  type_deconditionnement varchar(16)  not null
...
(
  ...
  commande_order_date  date         not null,
  produit_id           integer      not null
    constraint fkrqxepb1nx0y6syip91743n5pa
      references produit,
  constraint ukn10p7uup6gxluq30lcl0bgj5w
    unique (num_lot, produit_id),
...
(
  ...
  produit_id      integer                    not null
    constraint fkdhdiuc2eglbqm449qauj1cp0r
      references produit,
  tiers_payant_id integer                    not null
...
(
  ...
  lot_id               integer
    constraint fksq7ju65jlgejnnvj1ep3d1vmo
      references lot,
  motif_retour_id      integer      not null
...
(
  ...
  qty_mvt               integer      not null
    constraint reponse_retour_bon_item_qty_mvt_check
      check (qty_mvt >= 0),
  reponse_retour_bon_id integer      not null
    constraint fk3kiwqjsi0e810eo3x76r3b9b
      references reponse_retour_bon,
  retour_bon_item_id    integer      not null
...
create table retour_depot_item
(
  id                 integer generated by default as identity
    primary key,
  after_stock        integer,
  init_stock         integer not null,
  qty_mvt            integer not null
    constraint retour_depot_item_qty_mvt_check
      check (qty_mvt >= 1),
  regular_unit_price integer not null,
  produit_id         integer not null
    constraint fkrdwk1to468nuy966odh52s506
      references produit,
  retour_depot_id    integer
    constraint fkipbnufhijr5h5lwa6v66bp8fl
      references retour_depot
);
...
(
  id                         integer generated by default as identity
    primary key,
  date_mtv                   timestamp(6) not null,
  product_still_out_of_stock boolean      not null,
  qty                        integer      not null,
  fournisseur_id             integer      not null
    constraint fk2swy7j7ymdk3oakuooexgpjsk
      references fournisseur,
  produit_id                 integer      not null
    constraint fkremv5rad6pbew43d0ft0rbvcm
      references produit
);
...
(
  id                        integer generated by default as identity
    primary key,
  classe_criticite          varchar(3)    not null
    constraint semois_configuration_classe_criticite_check
      check ((classe_criticite)::text = ANY
             ((ARRAY ['A_PLUS'::character varying, 'A'::character varying, 'B'::character varying, 'C'::character varying, 'D'::character varying])::text[])),
  coefficient_securite      numeric(3, 2) not null,
  created_at                timestamp(6)  not null,
  date_dernier_calcul       timestamp(6),
  delai_livraison_jours     integer       not null
    constraint semois_configuration_delai_livraison_jours_check
      check (delai_livraison_jours >= 1),
  facteur_saisonnier_actuel numeric(3, 2),
  limite_peremption         boolean,
  nb_mois_historique        integer       not null
    constraint semois_configuration_nb_mois_historique_check
      check (nb_mois_historique >= 3),
  stock_objectif_calcule    integer,
  updated_at                timestamp(6)  not null,
  vmm_calcule               integer,
  produit_id                integer       not null
    constraint uq_semois_config_produit
      unique
    constraint fknueiu9qe9saj14jjaix6vxmhb
      references produit
);



create index idx_semois_config_produit
  on semois_configuration (produit_id);

create index idx_semois_config_classe
  on semois_configuration (classe_criticite);

create index idx_semois_config_updated
  on semois_configuration (updated_at);
...
(
  ...
  seuil_mini       integer
    constraint stock_produit_seuil_mini_check
      check (seuil_mini >= 0),
  stock_reassort   integer
    constraint stock_produit_stock_reassort_check
      check (stock_reassort >= 0),
  updated_at       timestamp(6) not null,
  produit_id       integer      not null
...
comment on column stock_produit.seuil_mini is 'Seuil minimum de stock pour reassortiment automatique ou suggestion de commande';

comment on column stock_produit.stock_reassort is 'Quantite de reassort pour la reconstitution de stock';
...
(
  ...
  stock_after         integer      not null,
  stock_before        integer      not null,
  type_ajust          varchar(15)  not null
  ...
  ajust_id            integer      not null
    constraint fkex9228479j8udon2wd8gm5dot
      references ajust,
  motif_ajustement_id integer
    constraint fkpstvc4bcssojfv5absxm5vtba
      references motif_ajustement,
  stock_produit_id    integer      not null
    constraint fkgu2b4oodkbl8aw0m46c2evbli
      references stock_produit,
  constraint ukesxntmrp8inb4lb4i3lsmg0xq
    unique (ajust_id, stock_produit_id)
);
...
(
  ...
  stock_produit_id     integer      not null
    constraint fkil10dduqkuyuf02jffy0rrrfi
      references stock_produit,
  stock_src_produit_id integer
    constraint fkfv43qjphxfshassymjb95d551
      references stock_produit,
...
(
  id             integer generated by default as identity
    primary key,
  type_substitut varchar(15) not null
...
(
  ...
  clesecuriteowner_id integer      not null
    constraint fk6gaf4th30fmybaaj5xp00kw7
      references app_user,
  connecteduser_id    integer      not null
...
(
  ...
  created_at      timestamp(6) not null,
  freeze_date     timestamp(6),
  is_frozen       boolean      not null,
  montant_ca      integer      not null
    constraint ventes_mensuelles_agregees_montant_ca_check
      check (montant_ca >= 0),
  nombre_ventes   integer      not null
    constraint ventes_mensuelles_agregees_nombre_ventes_check
      check (nombre_ventes >= 0),
  quantite_vendue integer      not null
    constraint ventes_mensuelles_agregees_quantite_vendue_check
      check (quantite_vendue >= 0),
  updated_at      timestamp(6) not null,
  produit_id      integer      not null
    constraint fkoqh7pmhf9hrmbx5p0jmq9j5up
      references produit,
  constraint uq_ventes_agregees_produit_mois
    unique (produit_id, annee_mois)
);



create index idx_ventes_mensuelles_produit
  on ventes_mensuelles_agregees (produit_id);

create index idx_ventes_mensuelles_date
  on ventes_mensuelles_agregees (annee_mois);

create index idx_ventes_mensuelles_frozen
  on ventes_mensuelles_agregees (is_frozen, annee_mois);

create index idx_ventes_mensuelles_updated
  on ventes_mensuelles_agregees (updated_at);
