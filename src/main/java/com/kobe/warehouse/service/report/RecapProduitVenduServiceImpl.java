...
public class RecapProduitVenduServiceImpl implements RecapProduitVenduService {
    ...
    public RecapProduitVenduSummary getRecapProduitVenduSummary(RecapProduitVenduRequestParam requestParam) {
        ...
        sb.append("SELECT COALESCE(SUM(sl.quantity_sold),0) AS quantity_sold, ")
        ...
        Integer qtySold = row[0] != null ? ((Number) row[0]).intValue() : 0;
        Integer qtyAvoir = row[1] != null ? ((Number) row[1]).intValue() : 0;
        Long totalSales = row[2] != null ? ((Number) row[2]).longValue() : 0L;
        Long totalPurchase = row[3] != null ? ((Number) row[3]).longValue() : 0L;
        return new RecapProduitVenduSummary(qtySold, qtyAvoir, totalSales, totalPurchase);
    }
    ...
    private String buildHavingClause(RecapProduitVenduRequestParam requestParam) {
        ...
        // Having clause for quantity sold
