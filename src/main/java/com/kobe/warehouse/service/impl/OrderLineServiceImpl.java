...
public class OrderLineServiceImpl implements OrderLineService {
  ...
  public OrderLine createOrderLine(OrderLine orderLine) {
    return this.orderLineRepository.saveAndFlush(orderLine);
  }
  ...
  public OrderLine buildOrderLineFromOrderLineDTO(OrderLineDTO orderLineDTO) {
    Produit produit = this.produitRepository.getOne(orderLineDTO.getProduitId());
    Optional<FournisseurProduit> fournisseurProduitOptional =
        this.fournisseurProduitService.findFirstByProduitIdAndFournisseurId(
  ...
  public Pair<OrderLine, OrderLine> updateOrderLineQuantityRequested(OrderLineDTO orderLineDTO) {
    OrderLine orderLine = this.orderLineRepository.getOne(orderLineDTO.getId());
  ...
  @Override
  public OrderLine updateIncrementOrderLineQuantityRequested(OrderLineDTO orderLineDTO) {
    OrderLine orderLine = this.orderLineRepository.getOne(orderLineDTO.getId());
    updateOrderLine(orderLine, orderLineDTO.getQuantityRequested());
    return this.orderLineRepository.saveAndFlush(orderLine);
  }
  ...
  @Override
  public void updateOrderLineQuantityReceived(OrderLineDTO orderLineDTO, OrderLine orderLine) {}
  ...
  private FournisseurProduit createNewFournisseurProduit(OrderLineDTO orderLineDTO, Produit produit)
    ...
    return this.fournisseurProduitService.createNewFournisseurProduit(
  ...
  public Optional<OrderLine> findOneFromCommande(
    ...
    return this.orderLineRepository.findFirstByFournisseurProduitIdAndCommandeId(
        fournisseurProduitOptional.get().getId(), commandeId);
  }

  @Override
  public void updateCodeCip(OrderLineDTO orderLineDTO) {
    OrderLine orderLine = this.findOneById(orderLineDTO.getId()).get();
    this.fournisseurProduitService.updateCip(
  ...
  public Optional<FournisseurProduit> getFournisseurProduitByCriteria(
    ...
    return this.customizedProductService.getFournisseurProduitByCriteria(criteria, fournisseurId);
  }

    @Override
    public int produitTotalStock(FournisseurProduit fournisseurProduit) {
        return this.customizedProductService.produitTotalStock(fournisseurProduit.getProduit());
    }

    @Override
    public int produitTotalStockWithQantitUg(Produit produit) {
        return this.customizedProductService.produitTotalStock(produit);
    }
