...
| 5.3 | MAJEUR | Factoriser les 3 methodes de chargement | -80 lignes, moins de bugs | Faible |
| 5.4 | MAJEUR | Standardiser extractApiError() partout | Coherence, maintenabilite | Faible |
| 5.5 | MAJEUR | Remplacer Subjects par signaux/observables | Decouplage, testabilite | Eleve |
| 5.6 | MOYEN | Corriger effect previousLoadingState | Performance | Faible |
| 5.7 | MOYEN | Supprimer services morts | Clarte du code | Tres faible |
| 5.8 | MOYEN | Adopter customerHandling dans Creation/Devis | Coherence | Moyen |
| 5.9 | BAS | Unifier clearError() | Coherence | Tres faible |
