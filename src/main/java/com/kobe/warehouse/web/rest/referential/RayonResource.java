...
public class RayonResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of rayons in
     * body.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the rayonDTO,
