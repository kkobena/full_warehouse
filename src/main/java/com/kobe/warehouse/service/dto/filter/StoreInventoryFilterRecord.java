...
public record StoreInventoryFilterRecord(Set<InventoryCategory> inventoryCategories, Set<InventoryStatut> statuts, Long storageId, Long rayonId, Long userId) {}
