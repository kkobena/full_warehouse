...
public interface AssuredCustomerService {
  ...
  default ClientTiersPayant getClientTiersPayantFromDto(
      AssuredCustomerDTO dto, ClientTiersPayant o) {
  ...
  default ClientTiersPayant updateClientTiersPayantFromDto(
  ...
  ClientTiersPayant upadateClientTiersPayant(
      ClientTiersPayantDTO c, ClientTiersPayant o, AssuredCustomer assuredCustomer);
  ...
  List<AssuredCustomerDTO> fetch(String query, String typeTiersPayant);
