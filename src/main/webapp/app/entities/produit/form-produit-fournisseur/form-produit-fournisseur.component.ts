    ...
    if (this.entity) {
      this.fournisseurService
        ...
        .subscribe((res: HttpResponse<IFournisseur[]>) => {
          ...
          this.fournisseurSelected = this.fournisseurs.find(e => e.id === this.entity!.fournisseurId) || null;
          if (this.fournisseurSelected?.id) this.fournisseurSelectedId = this.fournisseurSelected.id;
        });
    } else {
