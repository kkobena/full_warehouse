...
import com.kobe.warehouse.security.*;
...
public class SecurityConfiguration {
  ...
  // @Bean
  public SecurityFilterChain filterChain0(HttpSecurity http, MvcRequestMatcher.Builder mvc)
      throws Exception {
        ...
        .authorizeHttpRequests(
            authz ->
                ...
                authz
                    ...
                    .authenticated()*/
                    .requestMatchers(mvc.pattern("/java-client/account"))
                    .permitAll()
