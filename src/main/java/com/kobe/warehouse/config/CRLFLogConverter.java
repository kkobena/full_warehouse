...
/**
 * Log filter to prevent attackers from forging log entries by submitting input containing CRLF
 * characters. CRLF characters are replaced with a red colored _ character.
 *
