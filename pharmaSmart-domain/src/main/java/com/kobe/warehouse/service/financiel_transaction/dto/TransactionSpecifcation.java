...
public class TransactionSpecifcation {
    ...
    public TransactionSpecifcation setPaymentTransactionAmountCreated(LocalDateTime paymentTransactionAmountCreated) {
    ...
    public TransactionSpecifcation setTransactionCustomerFullName(String transactionCustomerFullName) {
    ...
    public TransactionSpecifcation setTransactionPaymentModeLibelle(String transactionPaymentModeLibelle) {
    ...
    public TransactionSpecifcation setPaymentTransactionTicketCode(String paymentTransactionTicketCode) {
