...
### Commande / Prompt
```
Agis comme un architecte logiciel et Conçois une architecture pour une application Spring Boot qui :
...
```
Agis comme un expert développeur Java et Écris un service Spring Boot pour lire des fichiers .data et .queue depuis un dossier d'entrée,
...
```
Agis comme un expert développeur Java et Génère un contrôleur REST Spring Boot avec endpoints :
...
### Commande / Prompt (Batch Processor)
```
Agis comme un reviewer senior et Analyse le code du service Batch Processor généré pour Spring Boot.
...
### Commande / Prompt (REST API)
```
Agis comme un reviewer senior et Revois le code du contrôleur REST généré.
